...
a = 0
speedy222 = 90 #SpeedYSpritePrincipal
speedx222 = 90 #SpeedXSpritePrincipal
...
def game2():
    ...
    def create_all_NPCs():
        ...
        citizen_mayor2 = sprites.create(assets.image("""
            citizen_mayor
        """), SpriteKind.Mayor1)
        villager_1 = sprites.create(assets.image("""
            villager1
        """), SpriteKind.Villagers)
        villager_2 = sprites.create(assets.image("""
            villager4
        """), SpriteKind.Villagers)
        villager_3 = sprites.create(assets.image("""
            villager6
        """), SpriteKind.Villagers)
        villager_4 = sprites.create(assets.image("""
            villager4
        """), SpriteKind.Villagers)
        ...
        villager_1.set_position(1433, 150)
        villager_2.set_position(1525, 175)
        citizen_mayor2.set_position(490, 1165)
        villager_3.set_position(260, 1483)
        villager_4.set_position(487,1723)
